...
var SweetAlert2LoaderService = class _SweetAlert2LoaderService {
  ...
  static ɵfac = function SweetAlert2LoaderService_Factory(ɵt) {
    return new (ɵt || _SweetAlert2LoaderService)(ɵɵinject(swalProviderToken));
  };
...
var SwalComponent = class _SwalComponent {
  ...
  static ɵfac = function SwalComponent_Factory(ɵt) {
    return new (ɵt || _SwalComponent)(ɵɵdirectiveInject(SweetAlert2LoaderService), ɵɵdirectiveInject(fireOnInitToken), ɵɵdirectiveInject(dismissOnDestroyToken));
  };
...
var SwalDirective = class _SwalDirective {
  ...
  static ɵfac = function SwalDirective_Factory(ɵt) {
    return new (ɵt || _SwalDirective)(ɵɵdirectiveInject(ViewContainerRef), ɵɵdirectiveInject(ComponentFactoryResolver$1));
  };
...
var SwalPortalComponent = class _SwalPortalComponent {
  template = null;
  static ɵfac = function SwalPortalComponent_Factory(ɵt) {
    return new (ɵt || _SwalPortalComponent)();
  };
  static ɵcmp = ɵɵdefineComponent({
...
var SwalPortalTargets = class _SwalPortalTargets {
  ...
  static ɵfac = function SwalPortalTargets_Factory(ɵt) {
    return new (ɵt || _SwalPortalTargets)();
  };
  static ɵprov = ɵɵdefineInjectable({
...
var SwalPortalDirective = class _SwalPortalDirective {
  ...
  static ɵfac = function SwalPortalDirective_Factory(ɵt) {
    return new (ɵt || _SwalPortalDirective)(ɵɵdirectiveInject(ComponentFactoryResolver$1), ɵɵdirectiveInject(Injector), ɵɵdirectiveInject(ApplicationRef), ɵɵdirectiveInject(TemplateRef), ɵɵdirectiveInject(SweetAlert2LoaderService), ɵɵdirectiveInject(SwalPortalTargets), ɵɵdirectiveInject(SwalComponent, 1));
  };
  static ɵdir = ɵɵdefineDirective({
...
function provideDefaultSwal() {
  return import("./sweetalert2.all-B64T2KOJ.js");
}
var SweetAlert2Module = class _SweetAlert2Module {
  ...
  static ɵfac = function SweetAlert2Module_Factory(ɵt) {
    return new (ɵt || _SweetAlert2Module)();
  };
