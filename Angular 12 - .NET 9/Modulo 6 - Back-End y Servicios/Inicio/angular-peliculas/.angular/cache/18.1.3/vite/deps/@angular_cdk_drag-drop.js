...
__ResetsLoader.ɵfac = function _ResetsLoader_Factory(ɵt) {
  return new (ɵt || __ResetsLoader)();
};
...
_DragDropRegistry.ɵfac = function DragDropRegistry_Factory(ɵt) {
  return new (ɵt || _DragDropRegistry)(ɵɵinject(NgZone), ɵɵinject(DOCUMENT));
};
...
_DragDrop.ɵfac = function DragDrop_Factory(ɵt) {
  return new (ɵt || _DragDrop)(ɵɵinject(DOCUMENT), ɵɵinject(NgZone), ɵɵinject(ViewportRuler), ɵɵinject(DragDropRegistry));
};
...
_CdkDragHandle.ɵfac = function CdkDragHandle_Factory(ɵt) {
  return new (ɵt || _CdkDragHandle)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(CDK_DRAG_PARENT, 12));
};
...
_CdkDropListGroup.ɵfac = function CdkDropListGroup_Factory(ɵt) {
  return new (ɵt || _CdkDropListGroup)();
};
...
_CdkDropList.ɵfac = function CdkDropList_Factory(ɵt) {
  return new (ɵt || _CdkDropList)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(DragDrop), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(ScrollDispatcher), ɵɵdirectiveInject(Directionality, 8), ɵɵdirectiveInject(CDK_DROP_LIST_GROUP, 12), ɵɵdirectiveInject(CDK_DRAG_CONFIG, 8));
};
...
_CdkDragPreview.ɵfac = function CdkDragPreview_Factory(ɵt) {
  return new (ɵt || _CdkDragPreview)(ɵɵdirectiveInject(TemplateRef));
};
...
_CdkDragPlaceholder.ɵfac = function CdkDragPlaceholder_Factory(ɵt) {
  return new (ɵt || _CdkDragPlaceholder)(ɵɵdirectiveInject(TemplateRef));
};
...
_DragDropModule.ɵfac = function DragDropModule_Factory(ɵt) {
  return new (ɵt || _DragDropModule)();
};
